 ...
 *
 *  --- Patched 2026-07 for modern (6.x) kernels by mjdeiter ---
 *  Original source: https://github.com/hevz/panasonic-hbtn
 *  Two API changes were required:
 *    1. acpi_driver.ops.remove changed signature from
 *       "int remove(struct acpi_device *)" to "void remove(struct acpi_device *)"
 *       somewhere around kernel 5.9+.
 *    2. sparse_keymap_free() no longer exists; keymap teardown is now
 *       handled automatically (devm-managed) by sparse_keymap_setup().
...
static const struct key_entry panasonic_keymap[] = {
    ...
    { KE_KEY, 0x4, { KEY_SCREENLOCK } }, /* Security (Ctrl+Alt+Del on Windows) */
    { KE_KEY, 0x6, { KEY_DIRECTION } }, /* Screen rotate */
    { KE_KEY, 0x8, { KEY_ENTER } }, /* Enter */
    { KE_KEY, 0xA, { KEY_KEYBOARD } }, /* Input Panel / soft keyboard */
    { KE_END, 0 }
};
